...
fs.readFile("src/data/players.csv", async (err, data) => {
  ...
  console.log("max player id: ", min_players)
  ...
  console.log(result[20]["total_points"])
...
// ​
// obj.from.path('/home/user/absolute/path/to/csv_FILE_YOU_WANT_TO_LOAD.csv').to.array(function (data) {
